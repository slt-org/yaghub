/**#####################################
  ...
  */
function getAnyVolumeRecipeFromWebAPP(element) {
  console.log(element);
  ...
  console.log("json object parsed from serverside: volume="+parsed_obj.volume);
  
  var volumeObject = anyVolumeCalcMetric(parsed_obj.volume)
 ...
 *  
 */
function anyVolumeCalcMetric(volume){
