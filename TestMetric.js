...
function testDisk_mGetDiskRecipeFromWebAPP(){
  var testrun = mGetDiskRecipeFromWebAPP('{"radius":"10","height":".3","units":"metric"}');
 console.log(" Test getDiskRecipeFromWebAPP run :"+JSON.stringify(testrun)); 
};
...
function testDisk_diskCalcMetric(){
  var testrun = diskCalcMetric(3,.6);
 console.log(" Test diskCalcMetric run :"+JSON.stringify(testrun)); 
};
